...
function handleCredentialResponse(response){
  // Decode JWT to get user profile info for display
  try{
  ...
  // Now request Drive access token (separate from identity token)
...
function fillForm(text){
  ...
  // (e.g. any @starhealth.in / @starthealth.in address, kani.spsubbu@gmail.com)
  // so the customer's own email is the one that gets filled in.
  let email='';
